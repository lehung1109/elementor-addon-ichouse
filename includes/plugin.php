...
final class Plugin
{
  ...
  public function register_widgets($widgets_manager): void
  {
    ...
    require_once __DIR__ . '/widgets/EAI-post-hero-banner.php';
    ...
    require_once __DIR__ . '/widgets/EAI-job-detail.php';
    ...
    $widgets_manager->register(new \EAI_Post_Hero_Banner_Widget());
    ...
    $widgets_manager->register(new \EAI_Job_Detail_Widget());
