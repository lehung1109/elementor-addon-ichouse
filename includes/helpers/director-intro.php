...
if (! function_exists('eai_director_intro_get_rc_props')) {
  /**
   * @param array<string, mixed> $settings
   * @return array<string, mixed>
   */
  function eai_director_intro_get_rc_props(array $settings): array
  {
    ...
    $target_id = trim((string) ($settings['scroll_reveal_target_id'] ?? 'director-intro'));
    if ($target_id === '') {
      $target_id = 'director-intro';
    }
