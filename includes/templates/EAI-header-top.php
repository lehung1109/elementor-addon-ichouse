...
<div>
  <div class="w-full bg-[#f36f21]">
    <div class="container">
      <div class="flex h-[52px] items-center justify-between gap-4">
        <p class="hidden text-sm font-medium text-white md:block">
          <?php echo $text; ?>
        </p>
        <div class="flex flex-1 justify-center md:max-w-[420px]">
          <div class="relative w-full max-w-[360px] md:max-w-[420px]">
            <input
              data-slot="input"
              class="w-full min-w-0 border-input px-2.5 py-1 transition-colors outline-none file:inline-flex file:h-6 file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground focus-visible:border-ring focus-visible:ring-ring/50 disabled:pointer-events-none disabled:cursor-not-allowed disabled:bg-input/50 disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 md:text-sm dark:bg-input/30 dark:disabled:bg-input/80 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 h-9 rounded-full border-0 bg-white pr-10 text-sm shadow-none placeholder:text-gray-400 focus-visible:ring-0 focus-visible:ring-offset-0"
              placeholder="<?php echo $search_placeholder; ?>" /><svg
              ...
              class="lucide lucide-search absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-500"
              aria-hidden="true">
